      ...
      <div class="contained">
        ...
        <div class="section__body">
          ...
          <div class="section-item section-item--text features">
            ...
            <div class="feature__text">
              Манипула позволяет точно адаптировать интенсивность и направление
              воздействия, обеспечивая полный контроль специалиста и
              максимальный комфорт клиента. Подходит как для интенсивной
        ...
        <div class="section__body">
          <div class="section-item">
            ...
            <div class="item-body">
              ...
              <div class="item-text">
                Эффективно корректирует фигуру, воздействуя на локальные жировые
                отложения в проблемных зонах: руки, спина, живот, бедра,
                ягодицы. Помогает достичь более стройного и подтянутого силуэта.
              </div>
            </div>
          </div>
          ...
          <div class="section-item">
            ...
            <div class="item-body">
              ...
              <div class="item-text">
                Манипула для лица и шеи позволяет мягко прорабатывать деликатные
                зоны, повышая упругость и устраняя признаки возрастных
                изменений.
              </div>
            </div>
          </div>
