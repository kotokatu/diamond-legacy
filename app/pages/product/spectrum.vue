  ...
  meta: [
    {
      name: "description",
      content:
        "Аппарат нового поколения для укрепления мышц и моделирования тела. Оснащён четырьмя независимыми манипулами, каждая из которых может работать отдельно или синхронно. Технология HI-EMT вызывает сверхмаксимальные мышечные сокращения, ускоряя метаболизм и способствуя формированию мышечного тонуса.",
    },
  ],
});
</script>
