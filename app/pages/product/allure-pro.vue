...
<script setup>
useHead({
  title: 'Аппарат для омоложения кожи Legacy Allure Pro с функцией RF микроигольчатого воздействия',
  meta: [
    { name: 'description', content: 'Фракционный RF-аппарат для омоложения кожи, включающий функции микронидлинга, крио- и термотерапии, а также вакуумной терапии. Работает в ручном и автоматическом режимах, обеспечивая точное и контролируемое воздействие на разные уровни кожи, улучшая её тонус, плотность и текстуру.' }
  ],
})
</script>
