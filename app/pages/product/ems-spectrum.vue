      ...
      <div class="contained">
        <div class="lead">
          ...
          <div class="lead__body text-h2">
            Legacy  Spectrum — профессиональный аппарат нового поколения для моделирования фигуры, укрепления мышц и улучшения тонуса кожи.
          </div>
        </div>
          ...
          <div class="section__grid grid">
            ...
            >
              ...
              <div class="feature__text">
                Технология HI-EMT (High-Energy Magnetic Therapy) основана на действии высокоинтенсивного электромагнитного поля, которое вызывает глубокие мышечные сокращения и активизирует обменные процессы.
              </div>
              <h3 class="feature__title text-h3">
                Насадки для разных зон
              </h3>
              <div class="feature__text">
                Аппарат оснащён четырьмя независимыми манипулами, каждая из которых может работать на отдельной зоне или синхронно — в зависимости от выбранной программы. Встроенная система охлаждения поддерживает комфортную температуру, предотвращая перегрев тканей даже при длительных сеансах.
              </div>
              <h3 class="feature__title text-h3">
                Безопасность и неинвазивность
              </h3>
              <div class="feature__text">
                Процедура не требует восстановления, не вызывает боли и подходит для клиентов любого возраста и уровня физической подготовки.
              </div>
              <!--
          ...
          <div class="section__grid grid">
            <div class="grid-item grid-item--text order-1">
              ...
              <div class="grid-item__body">
                ...
                <div class="grid-item__text">
                  Аппарат основан на действии технологии High-Intensity Electromagnetic Therapy — высокоинтенсивной электромагнитной стимуляции, вызывающий сверхмаксимальные мышечные сокращения. Такие сокращения невозможно достичь даже при интенсивной тренировке, что обеспечивает выраженный эффект укрепления и тонизирования мышц.
                </div>
              </div>
            </div>
            ...
            <div class="grid-item grid-item--text order-3">
              ...
              <div class="grid-item__body">
                ...
                <div class="grid-item__text">
                  Каждая манипула работает независимо, что позволяет одновременно воздействовать на разные зоны тела (например, живот, ягодицы, бёдра, руки). Это сокращает общее время процедуры и повышает эффективность работы специалиста.
                </div>
              </div>
            </div>
            ...
            <div class="grid-item grid-item--text order-5">
              ...
              <div class="grid-item__body">
                ...
                <div class="grid-item__text">
                  Встроенное активное охлаждение защищает кожу от перегрева, поддерживает стабильную температуру манипул и делает процедуру максимально комфортной. Благодаря этому сеанс проходит без боли, ожогов и ощущения жара даже при высокой мощности воздействия.
                </div>
              </div>
            </div>
            ...
            <div class="grid-item grid-item--text order-7">
              ...
              <div class="grid-item__body">
                ...
                <div class="grid-item__text">
                  Один сеанс вызывает до 20 000 сверхмаксимальных сокращений в целевой зоне. Уже после нескольких процедур наблюдается уменьшение жировых отложений, повышение тонуса мышц и улучшение контуров тела.
                </div>
              </div>
            </div>
            ...
            <div class="grid-item grid-item--text order-9">
              ...
              <div class="grid-item__body">
                ...
                <div class="grid-item__text">
                  Специалист может настраивать интенсивность, частоту и длительность импульсов под индивидуальные особенности каждого клиента. Это обеспечивает точную адаптацию процедуры и максимальный результат.
                </div>
              </div>
            </div>
          </div>
