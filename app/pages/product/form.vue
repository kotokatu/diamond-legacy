          ...
          <div class="section__grid grid">
            ...
            <div class="grid-item grid-item--text order-3">
              ...
              <div class="grid-item__body">
                ...
                <div class="grid-item__text">до 950 г за один сеанс.</div>
              </div>
            </div>
            ...
            <table class="section__table table table--characteristics">
              ...
              <tbody>
                <tr>
                  ...
                  <td>50 кг·см, с функцией автоматического контроля.</td>
                </tr>
                <tr>
                  <td>Напряжение</td>
...
<script setup>
useHead({
  title: 'Аппарат для коррекции фигуры Legacy Form с функциями вибрационно-роликового массажа и LED-воздействия (5 в 1)',
  meta: [
    { name: 'description', content: 'Аппарат для моделирования тела и лифтинга кожи 5 в 1. Объединяет технологии вибрационно-роликового массажа, LED-терапию, лимфодренаж, энергомассаж и 3D-воздействие. Оснащён пятью манипулами, которые могут работать одновременно, обеспечивая мощный дренажно-лифтинговый эффект и улучшение структуры кожи.' }
  ],
})
</script>
