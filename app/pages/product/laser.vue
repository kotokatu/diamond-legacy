  ...
  meta: [
    {
      name: "description",
      content:
        "Аппараты для лазерной эпиляции и удаления волос: профессиональное оборудование для салонов. Модели, цены, сколько стоит купить аппарат для эпиляции волос лазером.",
    },
  ],
});
</script>
