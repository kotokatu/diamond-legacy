...
<script setup>
useHead({
  title: 'Аппарат для коррекции фигуры Legacy Vela с технологиями ENDO и VLA Shape',
  meta: [
    { name: 'description', content: 'Современный аппарат, сочетающий технологию ENDO и VLA Shape (вакуум + инфракрасный свет + радиочастотные волны). Предназначен для лифтинга кожи, коррекции фигуры, лимфодренажа и борьбы с целлюлитом. Обеспечивает выраженный эффект подтяжки и повышения упругости после первых процедур. Комбинированное воздействие ENDO и VLA Shape позволяет уменьшить локальные жировые отложения и повысить тонус кожи.' }
  ],
})
</script>
