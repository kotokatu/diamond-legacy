    ...
    <div class="flex-center">
      <div class="contained">
        ...
        <p>
          ...
          Оператор может получить о посетителях веб-сайта https://.ru/
        </p>
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://.ru/
        </p>
        <p>
        ...
        <ul class="list-disc">
          ...
          <li>
            ...
            материалам, содержащимся на веб-сайте https://.ru/
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          специальные формы, расположенные на сайте https://.ru/ или
        ...
        <p>
          ...
          https://.ru/ с пометкой «Актуализация персональных данных».
        </p>
        <p>
          ...
          на электронный адрес Оператора https://.ru/ с пометкой «Отзыв согласия
