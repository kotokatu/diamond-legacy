    ...
    <div class="wrapper">
      <div class="contained">
        ...
        <p>
          ...
          всей информации, которую Оператор может получить о посетителях веб-сайта https://.ru/
        </p>

        <h2 class="text-h3">2. Основные понятия, используемые в Политике</h2>
        <p>
        ...
        <p>
          ...
          обеспечивающих их доступность в сети интернет по сетевому адресу https://.ru/
        </p>
        <p>
        ...
        <p>
          ...
          Пользователю веб-сайта https://.ru/
        </p>
        <p>
        ...
        <p>2.10. Пользователь — любой посетитель веб-сайта https://.ru/</p>
        <p>
        ...
        <h2 class="text-h3">3. Основные права и обязанности Оператора</h2>
        ...
        <h2 class="text-h3">4. Основные права и обязанности субъектов персональных данных</h2>
        ...
        <h2 class="text-h3">5. Оператор может обрабатывать следующие персональные данные Пользователя</h2>
        <p>5.1. Фамилия, имя, отчество.</p>
        <p>5.2. Номера телефонов.</p>
        <p>5.3. Адрес электронной почты.</p>
        <p>
        ...
        <h2 class="text-h3">6. Принципы обработки персональных данных</h2>
        ...
        <h2 class="text-h3">7. Цели обработки персональных данных</h2>
        ...
        <p>
          ...
          направив Оператору письмо на адрес электронной почты legacy-info@mail.ru с пометкой «Отказ от уведомлений о
        ...
        <h2 class="text-h3">8. Правовые основания обработки персональных данных</h2>
        <p>
          8.1. Правовыми основаниями обработки персональных данных Оператором являются: — уставные (учредительные)
          документы Оператора; — договоры, заключаемые между оператором и субъектом персональных данных; — федеральные
          законы, иные нормативно-правовые акты в сфере защиты персональных данных; — согласия Пользователей на
          обработку их персональных данных, на обработку персональных данных, разрешенных для распространения.
        </p>
        <p>
          8.2. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или отправки
          Пользователем самостоятельно через специальные формы, расположенные на сайте https://.ru/ или направленные
        ...
        <h2 class="text-h3">9. Условия обработки персональных данных</h2>
        <p>
        ...
        <h2 class="text-h3">10. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
        <p>
        ...
        <p>
          ...
          самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора https://.ru/ с
        ...
        <p>
          ...
          электронной почты на электронный адрес Оператора https://.ru/ с пометкой «Отзыв согласия на обработку
          персональных данных».
        </p>
        <p>
        ...
        <h2 class="text-h3">11. Перечень действий, производимых Оператором с полученными персональными данными</h2>
        <p>
        ...
        <h2 class="text-h3">12. Трансграничная передача персональных данных</h2>
        <p>
        ...
        <h2 class="text-h3">13. Конфиденциальность персональных данных</h2>
        <p>
        ...
        <h2 class="text-h3">14. Заключительные положения</h2>
      </div>
    </div>
  </div>
</template>
