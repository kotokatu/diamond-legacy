    ...
    >
      <div class="lead contained">
        ...
        <h2 id="about-title" class="lead__body text-h2">
          Legacy — бренд нового поколения профессионального оборудования,
          созданный компанией Diamond Technology совместно с ведущими инженерами
          из Кореи. В основе философии бренда — сочетание международного уровня
          технологий, передовых разработок и высоких стандартов качества,
          открывающее новые возможности в косметологии
        </h2>
      </div>
        ...
        <div class="section__grid grid contained">
          <div class="grid-item">
            <div class="grid-item__title">
              <AppDots :count="1" />
              <span class="text-nav text-sub">{ Надёжность и экспертиза }</span>
            </div>
            <div class="grid-item__text">
              За более чем 8 лет работы Diamond Technology оснастила более 5000
              клиник и салонов в России и за её пределами. Legacy создан на базе
              лучших практик индустрии, с исправлением недостатков, выявленных
              на рынке других производителей. Используются только современные,
              проверенные компоненты премиального уровня, а дизайн и функционал
              продуман до мельчайших деталей для безопасной и эффективной
              работы. Именно поэтому мы предоставляем пожизненную гарантию на
              все аппараты
            </div>
          </div>
          <div class="grid-item grid-item--last">
            <div class="grid-item__title">
              <AppDots :count="3" />
              <span class="text-nav text-sub"
                >{ Символ премиального качества }</span
              >
            </div>
            <div class="grid-item__text">
              Legacy — знак уверенности и качества для профессионалов. Аппараты
              бренда вдохновляют специалистов, повышают ценность их работы и
              формируют новые стандарты красоты
            </div>
          </div>
          <div class="grid-item">
            <div class="grid-item__title">
              <AppDots :count="2" />
              <span class="text-nav text-sub"
                >{ Новый стандарт в косметологии }</span
              >
            </div>
            <div class="grid-item__text">
              Legacy задаёт новые ориентиры в индустрии красоты, предлагая
              решения, не имеющие аналогов на рынке. Линейка аппаратов
              охватывает ключевые направления: моделирование фигуры, лазерные
              технологии, омоложение кожи и комплексный уход за телом. Эти
              решения помогают расширить спектр услуг, повысить качество
              обслуживания и вывести бизнес на новый уровень
            </div>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div class="grid-item order-4">
              ...
              <div class="grid-item__body">
                ...
                <div class="grid-item__text">
                  ...
                  круглосуточное сопровождение: консультации, ремонт,
              ...
              <div class="grid-item__body">
                ...
                <div class="grid-item__text">
                  <div class="q-pb-sm">
                    ...
                    оформления соцконтракта. Legacy берёт на себя всю бюрократию
                    и доводит дело до результата. Консультация по условиям
                    получения
                  </div>
            ...
            <div class="grid-item order-6">
              ...
              <div class="grid-item__body">
                ...
                <div class="grid-item__text">
                  При покупке аппарата Legacy предоставляется бесплатное
                  обучение в нашем обучающем центре, онлайн и офлайн. Выдаётся
                  диплом гос. образца или именной сертификат
                </div>
              </div>
            </div>
    ...
    <section id="distributors" class="flex-center section distributors">
      <div class="contained">
        <div class="lead">
          ...
          <h2 class="lead__body text-h2">Сотрудничество, которое работает</h2>
        </div>
        ...
        <div class="section__content">
          ...
          >
            ...
            <p>
              Пожизненная гарантия на все аппараты для клиентов через партнёров.
            </p>
            <p>
            ...
            <p>
              Обучение работе с оборудованием и маркетинговой стратегией продаж,
              чтобы вы могли эффективно развивать свой бизнес.
            </p>
            <p>
              Приоритетный доступ к новинкам линейки Legacy и новым технологиям.
            </p>
            <p>
              Полный набор маркетинговых инструментов: готовые инструкции, фото,
              видео и пошаговые планы продвижения для быстрого старта и успешных
              продаж.
            </p>
            <p>
              Совместные акции и промо-материалы, которые повышают узнаваемость
              бренда и привлекают новых покупателей.
            </p>
          </div>
        </div>
      </div>
